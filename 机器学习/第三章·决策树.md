...
## 决策树学习的假设空间搜索
ID3的优势：避免了搜索不完整的假设空间，避免了假设空间可能不包含目标函数的情况
不足：ID3仅维护单一的当前假设，不能判断有多少其他决策树和现有数据一致
## 例题 · playtennis
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MzM1MjEwODQsLTE3MTM1NDkwMiw3Mz
g2NzI3NjcsLTIwODg3NDY2MTJdfQ==
-->