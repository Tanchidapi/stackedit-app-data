...
## 一致学习器
某学习算法被称为一致学习器，说明其输出的假设在训练样例上有零错误率。即如果假设空间中有均匀的先验概率，且训练数据确定、无噪声，则ren
## 例题 · 病人患癌的概率
![输入图片说明](/imgs/2025-11-21/QDmBqcCp3sE6gWST.png)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5OTQ3NjQxMCwzODkwNzMyMDcsMTc3OT
Q3MTU5NSwtNDA0Njk4NTgxLDE3MzY4MzQ2MjIsLTQyMjU1MDcw
