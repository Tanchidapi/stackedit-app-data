...
1-5步为第一个阶段，6-7为第二个阶段。第一个阶段中，如果定义的变量被使用了，那么，make会把其展开在使用的位置。但make并不会完全马上展开，make使用的是拖延战术，如果变量出现在依赖关系的“规则”中，那么仅当这条依赖被决定要使用了，变量才会在其内部展开。
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NjM1MDUyNTUsLTQxNzc2MjgzNCwyOT
A2ODQzNDEsMTc0MDA4MTkxNCw3MTcxNjQ4NjEsLTg0OTM0MTQw
XX0=
-->