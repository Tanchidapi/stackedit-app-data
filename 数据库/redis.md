...
默认配置就是主节点，对从节点，可以通过命令配置或者修改配置文件，使用命令replicaof host port设置从节点，可以用role命令查看节点角色；配置文件修改redis.conf中对应的端口号和pid文件名，再修改dbfilename以区分主从节点
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg4MTMyODUxNSw5MzI0OTMxNCwtMTIxOD
