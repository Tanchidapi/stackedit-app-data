...
### 哨兵模式
哨兵会以一个独立的进程运行在redis集群中，执行下面几个功能：通过不断的发送命令来监控节点是否正常；如果某个节点出问题会通过发布订阅模式通知其他节点；
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMjk5NzA0NjgsOTMyNDkzMTQsLTEyMT
...
NjY3MywtMTAzMjM3NjQ1LDY4MzczNzMyOSwtOTQzMDMzMDkxLC
0yMDg4NzQ2NjEyXX0=
-->