...
### NewReno
NR在超时方面仍然和Tahoe相同，在收到三个重复ACK时也和Reno一样进行快速重传，但是在快速重传时会有一些精妙的操作，NR在每收到一个重复的ACK就会扩展一个窗口，因为其认为能收到ACK，说明数据包正在成功到达接收方，但是不能发送太快，因为出现了重复的ACK，正在接近网络的拥塞点
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MzQ4NzU4ODcsLTQzNzIyMjc2NSwxNT
gyODQ0ODg3LC00MjQxMzI5NywxMjQwOTc1OTcxLC03MzM2MzQz
OTgsNTAyOTY1NTU5LC0zMzAxMzk5NjQsLTE0NTg5MTIwODIsMT
