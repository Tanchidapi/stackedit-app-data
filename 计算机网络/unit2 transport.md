...
上述四个例子中的第四个是回复延迟的情况，这是所有可靠协议都会遇到的一个问题，这种情况下，第二次发送方收到的ack无法确认是哪一数据报对应的，停等协议下通过使用一个比特计数器解决问题，发送的数据和回传的ack有同样的计数


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA5MTg0Nzk5OSwtNjU0OTg3MjI4LC02MD
