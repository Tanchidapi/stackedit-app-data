...
![输入图片说明](/imgs/2025-08-20/5evYBZY1WEE23iFI.png)发送、接受、播放与缓冲的字节的关系图，其中，纵坐标是累积的字节数，横坐标是时间，曲线间水平方向的差分别表示了变化的延迟时长（因为排队延迟）和缓冲所用的时间，竖直方向上的查分别表示了缓冲路径上缓冲的数据量有多大和，


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MDc1NzI1LC04MzI5MzI0NTksLTIxND
