...
![输入图片说明](/imgs/2025-09-01/3wSrienaddkcuTEW.png)漏桶调节示意图。简单来说，漏桶调节就是通过一个令牌桶来模拟到达函数A的上限，图中上方的表示令牌桶，下方是缓冲区和数据包的转发示意图，当桶中有足够的
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDM4NzUxNjc4LDIwNzY4MDY1NzQsMTcwOT
